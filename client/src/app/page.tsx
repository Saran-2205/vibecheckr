...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-violet-600 p-3 sm:p-5 md:p-8 flex flex-col items-center justify-center font-sans overflow-x-hidden selection:bg-yellow-400 selection:text-black pt-12 pb-20">
              ...
              <AnimatePresence>
                {lastResult && (
                  <motion.div 
                    ...
                    className={`absolute inset-0 z-50 flex flex-col items-center justify-center p-4 sm:p-8 backdrop-blur-sm shadow-[inset_0px_0px_50px_rgba(0,0,0,0.5)] ${lastResult.isMatch ? 'bg-emerald-400/95' : 'bg-rose-500/95'}`}
                  >
